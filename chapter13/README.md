...
* Broad Network Access - Services are available over the network and accessed via standard protocols on any type of client (Mobile phone, tablet, desktop, etc.)# Chapter 13 Deploying Applications
